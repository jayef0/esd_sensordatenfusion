...
Die Sensornetzwerke werden zwischen zwei Typen unterschieden \cite{Ref_StuekerHomogeneSDF}. Der eine Typ ist das homogene Sensornetzwerk und der andere Typ ist das heterogene Sensornetzwerk \cite{Ref_StuekerHomogeneSDF}. In einem homogenen Sensornetzwerk verwenden alle Sensoren dasselbe physikalische Prinzip zum Messen. Die Sensoren in einem solchen Netzwerk unterliegen somit alle den gleichen Einschränkungen \cite{Ref_StuekerHomogeneSDF}.
...
Universität-GH Siegen, Zentrum für Sensorsysteme: \textit{"'Sensordatenfusion mit Kalman-Filtern Optimale Informationsverarbeitung"'}, xyz
